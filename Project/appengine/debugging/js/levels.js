...
Levels = [
    ...
    {   
        ...
        solutionCodes: "var kitten; highlightBlock(null); stepAnchor('When_Run'); highlightBlock(null); moveRobot('Right', 3); stepAnchor('Move_Robot'); highlightBlock(null); moveRobot('Down', 3); stepAnchor('4*RfZgzbkf!]z+hE30eD');",
    ...
    // Chap.1 - Level 2: LearnGrab/Drop
    {
        ...
        solutionCodes:"var bucket, rock;highlightBlock(null);stepAnchor('When_Run');highlightBlock(null);moveRobot('Left', 1);stepAnchor('Move_Robot');highlightBlock(null);moveRobot('Up', 1);stepAnchor(';%{Zp*TiWuZ)$P7_T~f{');highlightBlock(null);robotGrab('rock');stepAnchor('Robot_Grab');highlightBlock(null);moveRobot('Left', 3);stepAnchor('~4/zlLR%#9!r45%p=*Sh');highlightBlock(null);robotDrop('rock');stepAnchor('Robot_Drop');",
        checkLevelComplete: function() {
            var robotPos = Debugging.Game.getThingPos('robot');
    ...
    // Chap.1 - Level 3: Evaluation
    {
        ...
        solutionCodes:"var rock, bucket, basket, bird, kitten;highlightBlock(null);stepAnchor('When_Run');highlightBlock(null);moveRobot('Down', 2);stepAnchor('Move_Robot');highlightBlock(null);robotGrab('bird');stepAnchor('Robot_Grab');highlightBlock(null);moveRobot('Left', 4);stepAnchor('J%}byH7tsGm[.EI5@Fn7');highlightBlock(null);moveRobot('Up', 3);stepAnchor('}]tW2w8J|kGL$D0@P7ax');highlightBlock(null);robotGrab('rock');stepAnchor('nH3tL|h8i`Rmd%rda`WA');highlightBlock(null);moveRobot('Right', 3);stepAnchor('rlUS:DK+tN|+7ITBr-#A');highlightBlock(null);robotDrop('rock');stepAnchor('Robot_Drop');highlightBlock(null);moveRobot('Down', 2);stepAnchor(';/2I6rhQ$Jjdbg:1bmnx');highlightBlock(null);moveRobot('Left', 2);stepAnchor('mY5]/PwK`kXYQ]gysXRr');highlightBlock(null);robotDrop('bird');stepAnchor('R!$Fl.6T3]Dj}8oDRYyw');highlightBlock(null);moveRobot('Up', 1);stepAnchor('20E0ynGUm0(JW:ItoOh?');",
        checkLevelComplete: function(){
            var robotPos = Debugging.Game.getThingPos('robot');
            var bucketPos = Debugging.Game.getThingPos('bucket');
            var rockPos = Debugging.Game.getThingPos('rock');
    ...
    // Chap.2 - Level 4: LearnGoto
    {
        ...
        solutionCodes:"var piglet, basket, rock, kitten, bucket;highlightBlock(null);stepAnchor('When_Run');highlightBlock(null);robotGoto('rock');stepAnchor('Robot_Goto');highlightBlock(null);robotGrab('rock');stepAnchor('Robot_Grab');highlightBlock(null);robotGoto('bucket');stepAnchor('wp7aJjd(-jUZ{_Kd1?IQ');highlightBlock(null);robotDrop('rock');stepAnchor('Robot_Drop');highlightBlock(null);robotGoto('kitten');stepAnchor('#DN05|-W+NT,Us;#69b=');highlightBlock(null);robotGrab('kitten');stepAnchor('VP7!dMnicZIk_89gN)Kc');highlightBlock(null);robotGoto('basket');stepAnchor('a;;~Hwa|pl?ozhAPKcWK');highlightBlock(null);robotDrop('kitten');stepAnchor('MDT^ZXvf%HsJ{nfZ,;MB');highlightBlock(null);moveRobot('Up', 2);stepAnchor('Move_Robot');",
        checkLevelComplete: function(){
            var robotPos = Debugging.Game.getThingPos('robot');
            var bucketPos = Debugging.Game.getThingPos('bucket');
            var rockPos = Debugging.Game.getThingPos('rock');
    ...
    // Chap.2 - Level 5: LearnList
    {
        ...
        solutionCodes:"var kittens = ['kitten1', 'kitten2'];var kittens, basket, 變數;highlightBlock(null);stepAnchor('When_Run');highlightBlock(null);robotGoto(kittens[0]);stepAnchor('Robot_Goto');highlightBlock(null);robotGrab(kittens[0]);stepAnchor('Robot_Grab');highlightBlock(null);robotGoto(kittens.slice(-1)[0]);stepAnchor('3r=GsNMM{9J*)O8,^y$N');highlightBlock(null);robotGrab(kittens.slice(-1)[0]);stepAnchor('47*lEXPEq~:,[Lv@e_z~');highlightBlock(null);robotGoto('basket');stepAnchor(')OJC#|Uf-_?(ud:y^9_+');",
        checkLevelComplete: function(){
            var robotPos = Debugging.Game.getThingPos('robot');
    ...
    // Chap.2 - Level 6: Evaluation
    {
        ...
        solutionCodes: "var rocks = ['rock1', 'rock2'];var birds = ['bird1', 'bird2'];var puppys = ['puppy1', 'puppy2'];var basket, rocks, birds, puppys, kitten;highlightBlock(null);stepAnchor('When_Run');highlightBlock(null);robotGoto(birds[0]);stepAnchor('a0WIwJqku}xuSoQPWt-r');highlightBlock(null);robotGrab(birds[0]);stepAnchor('1-_=OsX.(^3J-!Y-4bbi');highlightBlock(null);robotGoto(birds.slice(-1)[0]);stepAnchor('SfL7biYC#Ud(%2L/N_}[');highlightBlock(null);robotGrab(birds.slice(-1)[0]);stepAnchor('I}l+cGG;r*^RFFZlyL.:');highlightBlock(null);robotGoto(puppys[0]);stepAnchor('lF@Ow@S{aF`9;?`Jnh/9');highlightBlock(null);robotGrab(puppys[0]);stepAnchor('Z-Al5:ionKJY$0G3REVU');highlightBlock(null);robotGoto(puppys.slice(-1)[0]);stepAnchor('.y8W,Sio(Vo.S,oC)c|8');highlightBlock(null);robotGrab(puppys.slice(-1)[0]);stepAnchor('Robot_Grab');highlightBlock(null);robotGoto('basket');stepAnchor('ISVZ3qH63mFD1.DJOVna');",
        checkLevelComplete: function(){
            var robotPos = Debugging.Game.getThingPos('robot');
    ...
    // Chap.3 - Level 7: LearnList
    {
        ...
        solutionCodes: "var boulders = ['boulder1', 'boulder2', 'boulder3', 'boulder4', 'boulder5', 'boulder6'];var dog, basket, rock, bucket, saythat, sayThis;highlightBlock(null);stepAnchor('When_Run');highlightBlock(null);robotGoto('dog');stepAnchor('Robot_Goto');highlightBlock(null);sayThis = '狗狗請幫幫我！';stepAnchor('5qN%B+mf+bpOu:;6?!Ux');highlightBlock(null);robotSay(sayThis);stepAnchor('48]0*8TA7i0I%?3zY#~f');",
        checkLevelComplete: function(){
            var robotPos = Debugging.Game.getThingPos('robot');
            var rockPos = Debugging.Game.getThingPos('rock');
    ...
    // Chap.3 - Level 8: LearnList
    {
        ...
        solutionCodes:"var dogs = ['dog1', 'dog2'];var boulders = ['boulder1', 'boulder2', 'boulder3', 'boulder4', 'boulder5', 'boulder6'];var basket, rat, note, 通關密語;highlightBlock(null);stepAnchor('When_Run');highlightBlock(null);moveRobot('Down', 1);stepAnchor('mtJ`^ngN`G#,|CTE,s~]');highlightBlock(null);通關密語 = ['dog1', 'safe', 'dog2'];stepAnchor('u~q2?*WItnr:0vev-3Cs');highlightBlock(null);robotSay(通關密語);stepAnchor('Xt8C0B@oQ~MOIeWWT(Mg');highlightBlock(null);robotGoto(通關密語[0]);stepAnchor('Robot_Goto');highlightBlock(null);robotGrab(通關密語[0]);stepAnchor('Robot_Grab');highlightBlock(null);moveRobot('Right', 1);stepAnchor('Move_Robot');highlightBlock(null);robotGoto(通關密語.slice(-1)[0]);stepAnchor('R#7*AWjrGKFCn/_.EPtF');highlightBlock(null);robotGrab(通關密語.slice(-1)[0]);stepAnchor('q=M3FCb-/ZIt%u;D#YxU');highlightBlock(null);robotGoto('basket');stepAnchor('F2EDZdGiANie^:)7$KDy');",
        checkLevelComplete: function(){
            var robotPos = Debugging.Game.getThingPos('robot');
    ...
    // Chap.3 - Level 9: Evaluation
    {
        ...
        solutionCodes:"var basket, kitten, 記憶中的名稱, piglet, puppy, rock;highlightBlock(null);stepAnchor('When_Run');highlightBlock(null);記憶中的名稱 = ['kitten', 'piglet', 'puppy'];stepAnchor('lists_split_simple');highlightBlock(null);robotGoto(記憶中的名稱[0]);stepAnchor('Robot_Goto');highlightBlock(null);robotGrab(記憶中的名稱[0]);stepAnchor('Robot_Grab');highlightBlock(null);robotGoto(記憶中的名稱[1]);stepAnchor('qBG_-!,sW)9Q(_Zi~wbE');highlightBlock(null);robotGrab(記憶中的名稱[1]);stepAnchor('[6dHiVARjS.DV+eDMDL[');highlightBlock(null);robotGoto(記憶中的名稱[2]);stepAnchor('tVmme#}^P}]?7,IQ*eI/');highlightBlock(null);robotGrab(記憶中的名稱[2]);stepAnchor('YJB1_$($ubg4D,!QP_nu');highlightBlock(null);robotGoto('basket');stepAnchor('S`fT6S=@t)zYDm?U~-a(');",
        checkLevelComplete: function(){
            var robotPos = Debugging.Game.getThingPos('robot');
            var kittenPos = Debugging.Game.getThingPos('kitten');
            var pigletPos = Debugging.Game.getThingPos('piglet');
    ...
    // Chap.4 - Level 10: LearnFunction
    {
        ...
        solutionCodes:"var boulders = ['boulder1', 'boulder2', 'boulder3', 'boulder4', 'boulder5', 'boulder6', 'boulder7', 'boulder8', 'boulder9', 'boulderA', 'boulderB', 'boulderC', 'boulderD', 'boulderE', 'boulderF', 'boulderG', 'boulderH', 'boulderI', 'boulderJ', 'boulderK', 'boulderL', 'boulderM', 'boulderN', 'boulderO'];var kitten;function 向右走再向下走() {  highlightBlock(null);  highlightBlock(null);  moveRobot('Right', 2);  stepAnchor('Move_Robot');  highlightBlock(null);  moveRobot('Down', 2);  stepAnchor('%@}$R}73R$60/|[QPSg(');}highlightBlock(null);stepAnchor('When_Run');highlightBlock(null);向右走再向下走();stepAnchor(')AhbX8|-i]9JhRvQX#gO');highlightBlock(null);向右走再向下走();stepAnchor('-UEm41gps:AjL^(,8Jvn');highlightBlock(null);向右走再向下走();stepAnchor('0OK90XzhqrfGlMF3t/59');",
        checkLevelComplete: function(){
            var robotPos = Debugging.Game.getThingPos('robot');
            var kittenPos = Debugging.Game.getThingPos('kitten');
    ...
    // Chap.4 - Level 11: LearnFunction2
    {
        ...
        solutionCodes:"var basket, 動物名稱, bucket, puppy, bird, piglet;function 拯救小動物(動物名稱) {  highlightBlock(null);  highlightBlock(null);  robotSay((String('拯救 ') + String(動物名稱)));  stepAnchor('Robot_Say');  highlightBlock(null);  robotGoto(動物名稱);  stepAnchor('Robot_Goto');  highlightBlock(null);  robotGrab(動物名稱);  stepAnchor('Robot_Grab');  highlightBlock(null);  robotGoto('basket');  stepAnchor('Ql;bC@[)dJ6K:[%:[]GB');  highlightBlock(null);  robotDrop(動物名稱);  stepAnchor('Robot_Drop');}highlightBlock(null);stepAnchor('When_Run');highlightBlock(null);拯救小動物('puppy');stepAnchor('KJm`[pY.LdoXFe,u-jl!');highlightBlock(null);拯救小動物('bird');stepAnchor('mt%I]W%?]{I,Zx3nL5a4');highlightBlock(null);拯救小動物('piglet');stepAnchor('+(!*;tt0F_rc0hD@Dz3O');",
        checkLevelComplete: function(){
            var robotPos = Debugging.Game.getThingPos('robot');
            var puppyPos = Debugging.Game.getThingPos('puppy');
            var birdPos = Debugging.Game.getThingPos('bird');
    ...
    // Chap.4 - Level 12: Evaluation
    {
        ...
        solutionCodes:"var rocks = ['rock1', 'rock2', 'rock3'];var basket, bucket, 目標石頭, rocks, 目標岩石;function 清理石頭(目標石頭) {  highlightBlock(null);  highlightBlock(null);  robotGoto(目標石頭);  stepAnchor('Robot_Goto');  highlightBlock(null);  robotGrab(目標石頭);  stepAnchor('Robot_Grab');  highlightBlock(null);  robotGoto('bucket');  stepAnchor('Ql;bC@[)dJ6K:[%:[]GB');  highlightBlock(null);  robotDrop(目標石頭);  stepAnchor('Robot_Drop');}highlightBlock(null);stepAnchor('When_Run');highlightBlock(null);清理石頭(rocks[0]);stepAnchor('KJm`[pY.LdoXFe,u-jl!');highlightBlock(null);清理石頭(rocks[1]);stepAnchor('mt%I]W%?]{I,Zx3nL5a4');highlightBlock(null);清理石頭(rocks[2]);stepAnchor('+(!*;tt0F_rc0hD@Dz3O');",
        checkLevelComplete: function(){
            var robotPos = Debugging.Game.getThingPos('robot');
    ...
    // Chap.5 - Level 13: LearnBoolean (If-Then)
    {
        ...
        solutionCodes:"var bird, piglet, 動物, kitten, medicine;function 前往檢查並放藥物上(動物) {  highlightBlock(null);  highlightBlock(null);  robotGoto(動物);  stepAnchor('Robot_Goto');  highlightBlock(null);  if ((checkInfection(動物)) == true) {    highlightBlock(null);    robotGrab(動物);    stepAnchor('Robot_Grab');    highlightBlock(null);    robotGoto('medicine');    stepAnchor('DfyE9:d(CDa{*xpsoYC]');    highlightBlock(null);    robotDrop(動物);    stepAnchor('Robot_Drop');  }  stepAnchor('t~FKH2PX2@6Nw.JuLLK`');}highlightBlock(null);stepAnchor('When_Run');highlightBlock(null);前往檢查並放藥物上('kitten');stepAnchor('Jc;@ByJ+a^u%izl,l.MQ');highlightBlock(null);前往檢查並放藥物上('bird');stepAnchor('mxGzj_o!K(57k1:1eE2o');highlightBlock(null);前往檢查並放藥物上('piglet');stepAnchor('kfO3PsgD8Cl9s0lPQt)W');function checkInfection(animal) {	flag = false;	if (animal == 'bird' || animal == 'piglet') {		flag = true;		robotSay(String(animal) + String(' 受到感染了！'))	} else {		robotSay(String(animal) + String(' 沒有受到感染'))	}	return flag;}",
        checkLevelComplete: function(){
            var robotPos = Debugging.Game.getThingPos('robot');
            var kittenPos = Debugging.Game.getThingPos('kitten');
            var birdPos = Debugging.Game.getThingPos('bird');
    ...
    // Chap.5 - Level 14: LearnBoolean (If-Then-Else)
    {
        ...
        solutionCodes: "var 動物, box, basket;function 前往檢查並分開放置(動物) {  highlightBlock(null);  highlightBlock(null);  robotGoto(動物);  stepAnchor(null);  highlightBlock(null);  if ((checkInfectionBefore(動物)) == true) {    highlightBlock(null);    robotGrab(動物);    stepAnchor('Robot_Grab');    highlightBlock(null);    robotGoto('box');    stepAnchor('DfyE9:d(CDa{*xpsoYC]');    highlightBlock(null);    robotDrop(動物);    stepAnchor('6oJ3WT#hM%5*y)4gCVSH');  } else {    highlightBlock(null);    robotGrab(動物);    stepAnchor('z5O05sbn1nGioAG3,r{-');    highlightBlock(null);    robotGoto('basket');    stepAnchor('4*{D]c`Z}yymrRczUF}w');    highlightBlock(null);    robotDrop(動物);    stepAnchor('^{[5lcqG]bRSIekW(G1q');  }  stepAnchor('t~FKH2PX2@6Nw.JuLLK`');}highlightBlock(null);stepAnchor('When_Run');highlightBlock(null);前往檢查並分開放置('dog');stepAnchor('Jc;@ByJ+a^u%izl,l.MQ');highlightBlock(null);前往檢查並分開放置('puppy');stepAnchor('mxGzj_o!K(57k1:1eE2o');function checkInfectionBefore(animal) {	flag = false;	if (animal == 'puppy') {		flag = true;		robotSay(String(animal) + String(' 曾經受過感染！'))	} else {		robotSay(String(animal) + String(' 不曾受過感染'))	}	return flag;}",
        checkLevelComplete: function(){
            var robotPos = Debugging.Game.getThingPos('robot');
            var puppyPos = Debugging.Game.getThingPos('puppy');
            var dogPos = Debugging.Game.getThingPos('dog');
    ...
    // Chap.5 - Level 15: Evaluation
    {
        ...
        solutionCodes:"var 動物, box, basket;function 前往檢查並分開放置(動物) {  highlightBlock(null);  highlightBlock(null);  robotGoto(動物);  stepAnchor('Robot_Goto');  highlightBlock(null);  if ((checkInfectionBefore(動物)) == true) {    highlightBlock(null);    robotGrab(動物);    stepAnchor('Robot_Grab');    highlightBlock(null);    robotGoto('box');    stepAnchor('DfyE9:d(CDa{*xpsoYC]');    highlightBlock(null);    robotDrop(動物);    stepAnchor('6oJ3WT#hM%5*y)4gCVSH');  } else {    highlightBlock(null);    robotGrab(動物);    stepAnchor('z5O05sbn1nGioAG3,r{-');    highlightBlock(null);    robotGoto('basket');    stepAnchor('4*{D]c`Z}yymrRczUF}w');    highlightBlock(null);    robotDrop(動物);    stepAnchor('U@-Q_s}FQYM_ZE2zFgd|');  }  stepAnchor('t~FKH2PX2@6Nw.JuLLK`');}highlightBlock(null);stepAnchor('When_Run');highlightBlock(null);前往檢查並分開放置('dog');stepAnchor('Jc;@ByJ+a^u%izl,l.MQ');highlightBlock(null);前往檢查並分開放置('puppy');stepAnchor('mxGzj_o!K(57k1:1eE2o');function checkInfectionBefore(animal) {	flag = false;	if (animal == 'puppy') {		flag = true;		robotSay(String(animal) + String(' 曾經受過感染！'))	} else {		robotSay(String(animal) + String(' 不曾受過感染'))	}	return flag;}",
        checkLevelComplete: function(){
            var robotPos = Debugging.Game.getThingPos('robot');
            var puppyPos = Debugging.Game.getThingPos('puppy');
            var dogPos = Debugging.Game.getThingPos('dog');
    ...
    // Chap.6 - Level 16: LearnLoop (For)
    {
        ...
        solutionCodes:"var boulders = ['boulder1', 'boulder2', 'boulder3', 'boulder4', 'boulder5', 'boulder6', 'boulder7', 'boulder8', 'boulder9', 'boulderA', 'boulderB', 'boulderC', 'boulderD', 'boulderE', 'boulderF', 'boulderG', 'boulderH', 'boulderI', 'boulderJ', 'boulderK', 'boulderL', 'boulderM', 'boulderN', 'boulderO', 'boulderP', 'boulderQ'];var kitten;function 向右走再向下走() {  highlightBlock(null);  highlightBlock(null);  moveRobot('Right', 2);  stepAnchor('Move_Robot');  highlightBlock(null);  moveRobot('Down', 2);  stepAnchor('%@}$R}73R$60/|[QPSg(');}highlightBlock(null);stepAnchor('When_Run');highlightBlock(null);for (var count = 0; count < 4; count++) {  highlightBlock(null);  向右走再向下走();  stepAnchor(')AhbX8|-i]9JhRvQX#gO');  highlightBlock(null);  stepAnchor('OC5lho7Y7!!R,Q[h0UuB');}stepAnchor('OC5lho7Y7!!R,Q[h0UuB');",
        checkLevelComplete: function(){
            var robotPos = Debugging.Game.getThingPos('robot');
            var kittenPos = Debugging.Game.getThingPos('kitten');
    ...
    {   
        ...
        // solutionCodes:"var counter = 0;var rock, human, kitten;highlightBlock(null);stepAnchor('When_Run');highlightBlock(null);while (stillHaveRocks()) {highlightBlock(null);robotGoto('rockTarget');stepAnchor('Robot_Goto');highlightBlock(null);robotSay('我在石頭的位置！');stepAnchor('Robot_Say');highlightBlock(null);counter = counter + 1;removeRock();stepAnchor('Robot_Remove_Rock');highlightBlock(null);stepAnchor('controls_whileUntil');}stepAnchor('controls_whileUntil');highlightBlock(null);robotGoto('human');stepAnchor('Sh;fRj]0Oj3fQwA^*)7t');highlightBlock(null);robotGrab('human');stepAnchor('Robot_Grab');highlightBlock(null);moveRobot('Left', 4);stepAnchor('](p*PSlD5TPDLycy4KQk');function stillHaveRocks() {changeRock();if (counter < 13) {robotSay('迪摩偵測到地圖中還有石頭');return true;}else {robotSay('迪摩偵測到場中已經沒有石頭！清除完畢！')return false;}}",
        solutionCodes:"var counter = 0;\nvar rock, human, kitten;\nhighlightBlock(null);\nstepAnchor('When_Run');\nhighlightBlock(null);\nwhile (stillHaveRocks()) {\nhighlightBlock(null);\nrobotGoto('rockTarget');\nstepAnchor('Robot_Goto');\nhighlightBlock(null);\nrobotSay('我在石頭的位置！');\nstepAnchor('Robot_Say');\nhighlightBlock(null);\ncounter = counter + 1;\nremoveRock();\nstepAnchor('Robot_Remove_Rock');\nhighlightBlock(null);\nstepAnchor('controls_whileUntil');\n}\nstepAnchor('controls_whileUntil');\nhighlightBlock(null);\nrobotGoto('human');\nstepAnchor('Sh;fRj]0Oj3fQwA^*)7t');\nhighlightBlock(null);\nrobotGrab('human');\nstepAnchor('Robot_Grab');\nhighlightBlock(null);\nmoveRobot('Left', 4);\nstepAnchor('](p*PSlD5TPDLycy4KQk');\nfunction stillHaveRocks() {\n\tchangeRock();\nif (counter < 13) {\nrobotSay('迪摩偵測到地圖中還有石頭')\nreturn true;\n} else {\nrobotSay('迪摩偵測到場中已經沒有石頭！清除完畢！')\nreturn false;\n\t}\n\t}",
        checkLevelComplete: function() {
            var robotPos = Debugging.Game.getThingPos('robot');
    ...
    {   
        ...
        solutionCodes:"var counter = 0;var human, glass;\nhighlightBlock(null);\nstepAnchor('When_Run');\nhighlightBlock(null);\nwhile (stillHaveGlass()) {  \nhighlightBlock(null);\n  robotGoto('glassTarget');\n  stepAnchor('Robot_Goto');\n  highlightBlock(null);\n  robotSay('我在玻璃的位置');\n  stepAnchor('Robot_Say');\n  highlightBlock(null);\n  for (var count = 0; count < 3; count++) { \n   highlightBlock(null);\n    counter = counter + 1;\n  removeGlass();\n    stepAnchor('Robot_Remove_Glass');\n    highlightBlock(null);\n    stepAnchor('controls_repeat_ext');\n  }\n  stepAnchor('controls_repeat_ext');\n  highlightBlock(null);\n  stepAnchor('controls_whileUntil');\n}\nstepAnchor('controls_whileUntil');\nhighlightBlock(null);\nrobotGoto('human');\nstepAnchor('Sh;fRj]0Oj3fQwA^*)7t');\nhighlightBlock(null);\nrobotGrab('human');\nstepAnchor('Robot_Grab');\nhighlightBlock(null);\nmoveRobot('Right', 5);\nstepAnchor('](p*PSlD5TPDLycy4KQk');\n\nfunction stillHaveGlass() {\n changeGlass();	\nif (counter < 21) {\n		robotSay('迪摩偵測到地圖中還有玻璃')\n		return true;\n	} else {\n		robotSay('迪摩偵測到場中已經沒有玻璃！掃除完畢！')\n		return false;\n	}\n }",
        checkLevelComplete: function() {
            var robotPos = Debugging.Game.getThingPos('robot');
            var humanPos = Debugging.Game.getThingPos('human');
